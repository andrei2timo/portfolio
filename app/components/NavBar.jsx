  ...
  return (
    ...
    <div className='fixed top-0 right-0 w-11/12 -z-10 translate-y-[-80%]'>
      ...
      <nav className={`w-full fixed px-5 lg:px-8 xl:px-[8%] py-4 flex
        ...
        <a href="#top">
            <Image src={assets.logo} alt="Logo-image" className='w-28 
        ...
        <div className='flex items-center gap-4'>
            ...
            <button>
                <Image src={assets.moon_icon} alt='Moon-image' className='w-6' />
            </button>
            ...
            <button className='block md:hidden ml-3' onClick={openMenu}>
                <Image src={assets.menu_black} alt='Menu-image' className='w-6' />
            </button>
        </div>
        ...
        top-0 bottom-0 w-64 z-50 h-screen bg-rose-50 transition duration-500'>
            ...
            <div className='absolute right-6 top-6' onClick={closeMenu}>
                <Image src={assets.close_black} alt='Close-image' className='w-5
                cursor-pointer'/>
            </div>
