...
const NavBar = ({isDarkMode, setIsDarkMode}) => {
  ...
  return (
    ...
    dark:hidden'>
        <Image src={assets.header_bg_color} alt='Header-image' className='w-full'/>
    </div>
      ...
      <nav className={`w-full fixed px-5 lg:px-8 xl:px-[8%] py-4 flex
        ...
        <a href="#top">
            <Image src={isDarkMode ? assets.logo_dark : assets.logo} alt="Logo-image" className='w-28 
        ...
        <div className='flex items-center gap-4'>
            ...
            <button className='block md:hidden ml-3' onClick={openMenu}>
                <Image src={isDarkMode ? assets.menu_white : assets.menu_black} alt='Menu-image' className='w-6' />
            </button>
        </div>
        ...
        top-0 bottom-0 w-64 z-50 h-screen bg-rose-50 transition duration-500 dark:bg-darkHover dark:text-white'>
            ...
            <div className='absolute right-6 top-6' onClick={closeMenu}>
                <Image src={isDarkMode ? assets.close_white : assets.close_black} alt='Close-image' className='w-5
                cursor-pointer'/>
            </div>
