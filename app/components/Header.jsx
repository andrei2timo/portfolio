  ...
  return (
    ...
    items-center justify-center gap-4'>
      ...
      <Image src={assets.hand_icon} alt='Hand-image' className='w-6'/>
          Salut! Sunt Andrei Morun, cunoscut sub numele de DJ Morone. 🎧 </motion.h3>
        ...
        className='text-3xl sm:text-6xl lg:text-[66px] font-Ovo'>
            DJ, pasionat de muzică și evenimente memorabile. </motion.h1>
            ...
            className='max-w-2xl mx-auto font-Ovo'>
              Dedicat să transform fiecare eveniment într-o experiență memorabilă prin muzică și energie pozitivă. 🔊
            </motion.p>
            ...
            <div className='flex flex-col sm:flex-row items-center gap-4 mt-4'>
                ...
                text-white flex items-center gap-2 dark:bg-transparent'>
                    Contact Me <Image src={assets.right_arrow_white} alt='Contact-image' 
